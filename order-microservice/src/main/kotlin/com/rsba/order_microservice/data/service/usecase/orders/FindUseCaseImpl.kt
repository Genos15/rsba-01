...
@Component(value = "find_order")
@OptIn(ExperimentalSerializationApi::class)
class FindUseCaseImpl : FindUseCase<Order>, IQueryGuesser {
    override suspend fun invoke(database: DatabaseClient, id: UUID, token: UUID): Optional<Order> =
